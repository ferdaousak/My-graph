...
//        popup.add(deplacer);
    ...
    private void clickGauch(java.awt.event.MouseEvent evt)
    {
        ...
        if(s!=null)
        {
        	//un sommet a ete selectionne
            if(deplacement)
            {
            	//on ete deja on mode de deplacement et maintenant on doit arreter le deplacement
                deplacement = false;
                selectionne = null;
                return;
            }
            if(selectionne == null)
            {//si on a rien selectionne avant alors maintenant on selectionne
                selectionne = s;
                selectionne.setSelected(true);
            }
            else
            {
            	// sinon on ajoute un arret qui lie les deux sommets selectionnes
                selectionne.setSelected(false);
        ...
        {
        	// l'emplacement du click est vide alors on va ajouter un nouveau sommet
            if(selectionne!=null)
            {
                deselectionne();
    ...
    private void clickDroit(java.awt.event.MouseEvent evt)
    {
        ...
        if(s!=null)
        {
        	//click droit sur un sommet: on affiche menu popup
            deselectionne();
            repaint();
            selectionne = s;
            covered=true;
